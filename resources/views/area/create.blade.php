...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <label class="navbar-brand" href="#">Informe de Fallas</label>
    ...
    <div class="container">
        <h1 class="text-center fw-light fs-1 pt-4">Agregar Area</h1>
        <div class="row">
            <div class="col-3">
                <form action="{{ route('area.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nombre_area" id="" class="form-control">
                    </div>
                    <div class="mb-3">
